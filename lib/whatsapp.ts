...
export const defaultTemplates = {
  ...
  enquiry_msg: `👋 *Hello {name}!* 📚✨\n\nThank you for visiting *Krishna Library* ({branch} branch) for an admission enquiry. We hope you liked our peaceful study ambiance and facilities! 🌿\n\n🪑 *Preferred Shift:* {interest}\n📍 *Branch Location:* {branch}\n\n✨ *Key Amenities & Facilities:*\n• Pin-drop silent & fully air-conditioned study spaces\n• Ultra high-speed fiber Wi-Fi\n• Personal charging points & ergonomic seating\n• Dedicated book lockers & purified RO drinking water\n\nIf you would like to confirm your admission or reserve your preferred seat, please visit our library front desk or reply to this message. Limited seats available! ⏳\n\nBest Regards,\n*Krishna Library Management* — {branch} 🚀`
};
