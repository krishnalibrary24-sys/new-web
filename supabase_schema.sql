...
--    Using anon key, so we enable RLS but allow full access.
-- ============================================================

ALTER TABLE public.members ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Allow full anon access to members" ON public.members;
CREATE POLICY "Allow full anon access to members"
...
CREATE POLICY "Allow full anon access to payments"
...
CREATE POLICY "Allow full anon access to leads"
...
-- DONE: 3 tables, RLS, Realtime, 15 members, 8 payments, 5 leads
