# 🗄️ 01. Database Schema & Supabase SQL Script (Mindspace Library)

Copy and run this entire SQL script in your Supabase project's **SQL Editor** to create all database tables required for **Mindspace Library**.
...
CREATE TABLE IF NOT EXISTS members (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    permanent_id VARCHAR(50) UNIQUE NOT NULL, -- e.g. 'MSL-101' for Mindspace Library
    ...
    branch VARCHAR(50) NOT NULL DEFAULT 'mindspace_main',
...
-- Seed Mindspace Library default branch
