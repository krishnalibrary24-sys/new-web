  ...
  return (
    <div className="bg-transparent text-v-on-background font-lexend antialiased selection:bg-v-primary/10 selection:text-v-primary visitor-page">
      ...
      <main>
        ...
        {/* ═══ 5. REVIEW MARQUEE ═══ */}
        <section className="py-14 bg-transparent border-y border-v-outline-variant/10 overflow-hidden relative z-50">
            ...
            <ScrollReveal className="relative z-50 pointer-events-auto">
              ...
              >
                <div className="flex items-center gap-2.5">
                  <h3 className="font-montserrat text-xl font-bold text-v-on-background group-hover:text-v-primary transition-colors">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[12px] text-v-on-surface-variant font-lexend group-hover:underline group-hover:text-v-primary transition-colors">Real reviews from Google</span>
                </div>
              </a>
            </ScrollReveal>
          </div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300"
