...
const TEMPLATE_CONFIG = [
  ...
  { key: 'enquiry_msg', label: 'Admission Enquiry WhatsApp Message', tags: '{name}, {interest}, {branch}, {phone}, {address}, {lib_name}' }
];
      ...
      {activeTab === 'system' && (
        <form onSubmit={handleSaveSettings} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-pane-elevated">
              <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 font-manrope mb-4 flex items-center gap-2">
                <span className="w-6 h-6 rounded-full bg-[#25D366]/15 text-[#25D366] flex items-center justify-center">
